# Документация: Система мини-АТС

## 1. Описание системы

### 1.1 Назначение
Система мини-АТС представляет собой клиент-серверное приложение для симуляции работы телефонной станции. Система позволяет множеству абонентов подключаться к серверу, совершать и принимать вызовы, а также обмениваться текстовыми сообщениями во время разговора.
...
Основные сущности:
- **АТС (MiniATS)** — управляет абонентами и соединениями
...
Система мини-АТС демонстрирует основные принципы построения клиент-серверных приложений с использованием TCP сокетов. Реализация включает управление состояниями, обработку событий, многопоточность и синхронизацию данных между множеством клиентов.
