...
- [Техническое задание](docs/TASKS.md) — детальное описание всех задач проекта
- [Диаграммы](docs/diagrams/) — ER-диаграмма, диаграмма классов, диаграмма последовательности (PlantUML)

## 🧪 Примеры сценариев

### Успешный вызов
1. Клиент A снимает трубку и звонит клиенту B
2. Клиент B принимает вызов
3. Оба обмениваются сообщениями
4. Один из них завершает вызов

### Лимит соединений
1. Установлено 4 соединения (максимум)
2. Пятый абонент снимает трубку и получает сигнал "Занято"
3. После освобождения линии может совершить вызов

### Обработка ошибок
- Вызов несуществующего номера → ошибка "Номер не найден"
- Вызов занятого абонента → ошибка "Абонент занят"
...
Проект разработан с регулярными коммитами для отслеживания прогресса:
...
Проект выполнен в рамках курсовой работы по объектно-ориентированному программированию. Реализованы:
- Модель «сущность-связь»
- Диаграмма классов
- Диаграмма последовательности
- Полная документация
- Работающая система с клиент-серверной архитектурой
